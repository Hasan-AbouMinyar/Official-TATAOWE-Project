        ...
        <div class="flex flex-col items-center flex-1 space-y-6">
            ...
            <nav class="flex flex-col items-center space-y-6">
                ...
                <router-link :to="{ name: 'Dashboard' }"
                    ...
                    :title="isOrganizationMode ? 'Organization Dashboard' : 'Dashboard'">
                ...
                <template v-if="isOrganizationMode">
                    ...
                    <router-link :to="{ name: 'OrganizationProfile', params: { id: organizationStore.organizationId } }"
                        class="p-2 transition-colors duration-300 rounded-lg group hover:bg-white"
                        active-class="p-3 transition-colors duration-300 bg-white rounded-lg"
                        ...
                        <svg class="w-5 h-5 stroke-blue-100/50" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path class="group-hover:stroke-blue-700"
                                d="M19 21V5C19 3.89543 18.1046 3 17 3H7C5.89543 3 5 3.89543 5 5V21M19 21H21M19 21H14M5 21H3M5 21H10M10 21V17C10 15.8954 10.8954 15 12 15C13.1046 15 14 15.8954 14 17V21M10 21H14M9 7H10M9 11H10M14 7H15M14 11H15"
                    ...
                    <router-link :to="{ name: 'MyOrganizations' }"
                        ...
                        <svg class="w-5 h-5 stroke-blue-100/50" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path class="group-hover:stroke-blue-700"
                                d="M8 7H5C4.46957 7 3.96086 7.21071 3.58579 7.58579C3.21071 7.96086 3 8.46957 3 9V18C3 18.5304 3.21071 19.0391 3.58579 19.4142C3.96086 19.7893 4.46957 20 5 20H14C14.5304 20 15.0391 19.7893 15.4142 19.4142C15.7893 19.0391 16 18.5304 16 18V15M16 5L21 10M21 10L16 15M21 10H9"
                                fill="#969CBA" fill-opacity="0.2" stroke="#969CBA" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </router-link>
                ...
                <a href="#" class="p-2 transition-colors duration-300 rounded-lg group hover:bg-white" title="Settings">
...
const handleLogout = async () => {
  if (isOrganizationMode.value) {
    // In organization mode, "logout" means back to personal account
    organizationStore.switchToPersonalAccount()
    router.push({ name: 'Dashboard' })
  } else {
    // In personal mode, logout normally
