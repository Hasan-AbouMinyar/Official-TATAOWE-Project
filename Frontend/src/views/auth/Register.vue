<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 font-sans flex items-center justify-center p-4 py-12">
    <div class="w-full max-w-2xl">
      <div class="bg-white shadow-md rounded-lg p-6 md:p-8">
        <!-- Logo/Header -->
        <div class="text-center mb-8">
          <div class="inline-flex items-center justify-center w-20 h-20 bg-white rounded-lg shadow-lg mb-4">
            <svg class="h-16 w-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
              <circle cx="50" cy="50" r="45" fill="#5B8DBE" />
            </svg>
          </div>
