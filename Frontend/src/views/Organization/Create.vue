        ...
        <form class="space-y-6" @submit.prevent="submit">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="form.name" id="name" type="text" placeholder="Your Organization's Name" class="w-full pl-10 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" required>
            </div>
          </div>
          ...
          <div>
            ...
            <textarea v-model="form.description" id="description" rows="4" placeholder="Tell us about your organization..." class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition"></textarea>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input v-model="form.phone" id="phone" type="tel" placeholder="+1 (555) 123-4567" class="w-full pl-10 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">
              </div>
            </div>
          </div>
